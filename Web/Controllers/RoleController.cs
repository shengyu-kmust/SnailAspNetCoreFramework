...
namespace Snail.Web.Controllers
{
    ...
    public class RoleController : DefaultBaseController, ICrudController<PermissionDefaultRole, RoleSaveDto, RoleResultDto, KeyQueryDto>
    {
        ...
        public RoleController(RoleService service, SnailControllerContext controllerContext,IPermissionStore permissionStore, IPermission permission) : base(controllerContext)
        {
