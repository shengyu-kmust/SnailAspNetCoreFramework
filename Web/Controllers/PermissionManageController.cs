...
namespace Web.Controllers
{
    ...
    {
        public PermissionManageController(AppDbContext db) : base(db)
        {
        }
        ...
        ////public PermissionManageController(AppDbContext db, ResourceRepository resourceRepository, ResourceService resourceService
